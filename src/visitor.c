...
static variable_t *variable_init(char *variable_name);

static value_t *visitor_visit_binary_expr(InterpreterContext *ctx, ast_t *node);
static value_t *visitor_visit_unary_expr(InterpreterContext *ctx, ast_t *node);
static value_t *visitor_visit_variable_definition(InterpreterContext *ctx, ast_t *node);
static value_t *visitor_visit_assignment(InterpreterContext *ctx, ast_t *node);
static value_t *visitor_visit_while_statement(InterpreterContext *ctx, ast_t *node);
static value_t *visitor_visit_if_statement(InterpreterContext *ctx, ast_t *node);
static value_t *visitor_visit_for_statement(InterpreterContext *ctx, ast_t *node);
static value_t *visitor_visit_function_call(InterpreterContext *ctx, ast_t *node);
static value_t *visitor_visit_function_definition(InterpreterContext *ctx, ast_t *node);
static value_t *visitor_visit_compound(InterpreterContext *ctx, ast_t *node);
static value_t *visitor_visit_string_literal(InterpreterContext *ctx, ast_t *node);
static value_t *visitor_visit_int_literal(InterpreterContext *ctx, ast_t *node);
static value_t *visitor_visit_float_literal(InterpreterContext *ctx, ast_t *node);
static value_t *visitor_visit_boolean(InterpreterContext *ctx, ast_t *node);
static value_t *visitor_visit_identifier(InterpreterContext *ctx, ast_t *node);
 ...
 * @param variable_name Variable identifier name string.
...
value_t *visitor_visit(InterpreterContext *ctx, ast_t *node)
{
    ...
    case AST_FUNCTION_DEFINITION:
        return visitor_visit_function_definition(ctx, node);
    case AST_FOR_STATEMENT:
        return visitor_visit_for_statement(ctx, node);
    default:
...
/* Register a native C function into the interpreter global built-ins table */
